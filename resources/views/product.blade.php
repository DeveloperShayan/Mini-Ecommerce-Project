                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="{{ $product->image_name }}" alt="Product" width="180" height="300"></a>
                                            ...
                                            <div class="product-item-content text-center mt-30">
                                                ...
                                                <span class="regular-price">PKR {{ $product->sale_price }}</span>
                                                <span class="discount-price">PKR {{ $product->price }}</span>
                                                <add-to-cart-button product-id="{{ $product->id }}" user-id="{{ auth()->user()->id ?? 0 }}" title="{{ $product->name }}" price="{{ $product->sale_price }}"></add-to-cart-button>
                                            </div>
