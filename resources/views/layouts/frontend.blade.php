                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ml-auto">
                                ...
                                @if (Route::has('login'))
                                    ...
                                    <div><cart/></div>
                                    <li class="nav-item">
                                        <a href="/home" class="btn btn-info btn-sm rounded-5"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
